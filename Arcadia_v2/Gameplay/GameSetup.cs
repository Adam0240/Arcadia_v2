...
namespace Arcadia_v2
{
    ...
    public static class GameSetup
    {
        ...
        private static void PrintIntroStory(IGameIO io)
        {
            ...
            io.WriteLine("is mapping the now abandoned forest while observing Pokemon in the area.");
            io.WriteLine("While observing a newly hatched Charmander, the sky is overtaken with clouds and it starts thundering and lightning.");
            ...
            io.WriteLine("You've been unconsious for so long I was worried I'd have to transport you in a pokeball to the hospital! ");
        ...
        private static void PrintPostNameStory(IGameIO io, Player mainPlayer)
        {
            ...
            io.WriteLine("Suddenly, from under your bed are two quick flashes of red light. Two pokemon appear in front of you.");

            io.WriteLine("Professor: Oh wow are these your Pokemon? They look very well taken care of.");
            io.WriteLine("You look at them and although you can't remember, you feel as though you've known these two for a long time.");
            io.WriteLine("You look under your bed where they had appeared. There are also two pokeballs with a note.");
            ...
            io.WriteLine("Welcome to the world of Pokemon!\n");
            ...
            io.WriteLine("This region is full of amazing Pokemon so go explore and get stronger!");
