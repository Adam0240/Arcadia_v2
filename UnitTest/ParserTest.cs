...
namespace UnitTest
{
    public class ParserTest
    {
        ...
        [InlineData("pokeinventory", ActionCommandType.PokeInventory)]
        [InlineData("pi", ActionCommandType.PokeInventory)]
        ...
        [InlineData("gym", MenuCommandType.Gym)]
        [InlineData("g", MenuCommandType.Gym)]
